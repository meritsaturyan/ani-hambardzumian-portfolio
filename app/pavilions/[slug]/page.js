      ...
      <main className="flex-1">
        <section className="section">
          <div className="container-page">
            {/* ОБЩИЙ КОНТЕЙНЕР 2-Х КОЛОНОК */}
            <div className="relative lg:flex lg:items-start lg:gap-10">
              {/* ЛЕВАЯ КОЛОНКА — БЛОК БРОНИРОВАНИЯ
                  немного выезжает влево на больших экранах */}
              <div className="relative flex-none z-[80] lg:-ml-8 xl:-ml-16">
                <BookingSidebar pavilion={pavilion} />
              </div>

              {/* ПРАВАЯ КОЛОНКА — КОНТЕНТ СТУДИИ */}
              <div className="relative flex-1 min-w-0 mt-10 lg:mt-0 z-0 space-y-8">
                <div className="space-y-4">
                  ...
                  <div className="relative rounded-3xl overflow-hidden shadow-card mt-4 z-0">
                    <img
                      src={
